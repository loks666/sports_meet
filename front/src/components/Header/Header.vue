<template>
  <div
    style="height: 50px; line-height: 50px; border-bottom: 1px solid #ccc; display: flex;background:linear-gradient(to bottom,#87CEFA,#b6fbff)">
    ...
    <el-dialog :visible.sync="dialogFormVisible" title="个人信息">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label-width="formLabelWidth" label="性别:">
              ...
              <el-tag :type="vale" effect="dark" size="medium" style="float:left">{{ form.sex }}</el-tag>
            </el-form-item>
          </el-col>
...
<script>
import {UpdatePwdAPI, UselectByIdAPI} from '@/request/api';
