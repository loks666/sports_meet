<template>
  <div>
    ...
    >
      ...
      <el-submenu v-if="this.role === 'superAdmin'" index="1">
        <template slot="title">
      ...
      <el-submenu v-if="this.role === 'admin'|| this.role === 'superAdmin'" index="2">
        <template slot="title">
          <i class="el-icon-s-order"></i>
          <span>用户管理</span>
        </template>
      ...
      <el-submenu v-if="this.role === 'admin'|| this.role === 'superAdmin'" index="3">
        <template slot="title">
          <i class="el-icon-s-order"></i>
          <span>比赛管理</span>
        </template>
      ...
      <el-submenu v-if="this.role === 'admin' || this.role === 'superAdmin'" index="5">
        <template slot="title">
          <i class="el-icon-s-order"></i>
          <span>加油稿管理</span>
        </template>
