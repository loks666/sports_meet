<template>
  <div class="ae">
    <div style="margin-bottom:10px">
      <el-input v-model="competition_ne" placeholder="请输入比赛名称" style="width:200px">
      </el-input>
    ...
    <basic-container>
      ...
      >
        ...
        <template slot="menuLeft">
          ...
          <!--          自定义新增-->
          <el-dialog :visible.sync="dialogFormVisible" title="新增比赛项目">

            <el-form ref="formsing" :model="formsing" :rules="rulesing" label-width="100px">

              <!--        一行-->
              <el-row>

                <el-col :span="12">
                  <el-form-item :label-width="formLabelWidth" label="比赛编号:" prop="Cnumber">
                ...
                <el-col :span="12">
                  <el-form-item :label-width="formLabelWidth" label="比赛名称:" prop="Cname">
              ...
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item :label-width="formLabelWidth" label="比赛开始时间:" prop="Cstart">
                    <el-date-picker
                ...
                <el-col :span="12">
                  <el-form-item :label-width="formLabelWidth" label="比赛结束时间:" prop="Cend">
                    <el-date-picker
              ...
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item :label-width="formLabelWidth" label="报名开始时间:" prop="Astart">
                    <el-date-picker
                ...
                <el-col :span="12">
                  <el-form-item :label-width="formLabelWidth" label="报名结束时间:" prop="Aend">
                    <el-date-picker
              ...
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item :label-width="formLabelWidth" label="比赛地点:" prop="Csite">
                ...
                <el-col :span="12">
                  <el-form-item :label-width="formLabelWidth" label="参赛人数:" prop="Ctnor">
...
import {CdeleteAPI, CinsertAPI, CselectSiteAPI, CupdateAPI, MgetLisetAPI, MselectAll} from '@/request/api';
