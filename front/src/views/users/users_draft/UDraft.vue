<template>
  <div
    ...
    <div v-for="(item,index) in draftList" :key="index" class="block">
      ...
      <div
        ...
        <div style="display: flex;">  <!-- 分栏-->
          ...
          <div style="width: 32px;height: 32px;margin-left:15px;margin-top:4px"><img src="static/img/像素_游戏机.png">
          </div>
        </div>
        <div class="texts">
          <textarea class="textarea-text" cols="105" readonly rows="5.7">{{ item.draftContent }}</textarea></div>
      </div>
