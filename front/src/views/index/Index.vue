    ...
    <basic-container>
      ...
      >
        ...
        <template slot="menuLeft">
          ...
          <el-button icon="el-icon-delete" type="danger" @click="toggleSelection()">删除选中</el-button>
          <el-button icon="el-icon-download" type="success" @click="handleExcel">导出表格</el-button>
          <el-button icon="el-icon-upload" type="success" @click="handleGet">下载模版</el-button>
          <!--          记得加：headers(请求头，一般用来放token)-->
          <el-upload :before-upload="Bupload"
                     ...
                     class="upload">
            <el-button :disabled="BtnDisabled" :icon="BtnIcon" type="success" @click="">{{ BtnText }}</el-button>
            <div slot="tip" class="upload2">只能上传Excel文件</div>
          </el-upload>
          ...
          <el-dialog :visible.sync="dialogFormVisible" title="新增用户">
            ...
            <el-form ref="forms" :model="forms" :rules="rules" label-width="100px">
              ...
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item :label-width="formLabelWidth" label="学号:" prop="id">
              ...
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item :label-width="formLabelWidth" label="性别:" prop="sex" style="float:left">
                    <el-radio v-model="forms.sex" border label="0">男</el-radio>
                    <el-radio v-model="forms.sex" border label="1">女</el-radio>
                  </el-form-item>
                </el-col>

                <el-col :span="12">
                  <el-form-item :label-width="formLabelWidth" label="号码:" prop="number">
              ...
              <el-row>
                ...
                <el-col :span="12">
                  <el-form-item :label-width="formLabelWidth" label="学院:" prop="college">
